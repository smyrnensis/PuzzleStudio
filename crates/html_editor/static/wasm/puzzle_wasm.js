...
export class WasmCoreRuntime {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WasmCoreRuntimeFinalization.unregister(this);
        return ptr;
    }
    free() {
    ...
    current_state_hash() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.wasmcoreruntime_current_state_hash(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    constructor(source, puzzle_path) {
        ...
        const ret = wasm.wasmcoreruntime_new(ptr0, len0, ptr1, len1);
        if (ret[2]) {
     ...
     * @returns {string}
     */
    transition_current_state_outcome(program_key, level_index, input) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(program_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmcoreruntime_transition_current_state_outcome(this.__wbg_ptr, ptr0, len0, level_index, input);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @returns {string}
     */
    transition_program_outcome(program_key, level_index, state_json, input) {
        let deferred4_0;
        let deferred4_1;
        try {
            const ptr0 = passStringToWasm0(program_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            ...
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.wasmcoreruntime_transition_program_outcome(this.__wbg_ptr, ptr0, len0, level_index, ptr1, len1, input);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
...
if (Symbol.dispose) WasmCoreRuntime.prototype[Symbol.dispose] = WasmCoreRuntime.prototype.free;
...
export class WasmPuzzle3Runtime {
     ...
     * @returns {string}
     */
    transition_program_outcome(program_key, state_json, input) {
        let deferred4_0;
        let deferred4_1;
        try {
            const ptr0 = passStringToWasm0(program_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            ...
            const ptr1 = passStringToWasm0(state_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.wasmpuzzle3runtime_transition_program_outcome(this.__wbg_ptr, ptr0, len0, ptr1, len1, input);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function solve_state(source, puzzle_path, state_json, max_depth, max_nodes, max_ms) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.solve_state(ptr0, len0, ptr1, len1, ptr2, len2, max_depth, max_nodes, max_ms);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
 ...
 * @returns {string}
 */
export function transition_program_outcome(source, program_key, level_index, state_json, input) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(program_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(state_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.transition_program_outcome(ptr0, len0, ptr1, len1, level_index, ptr2, len2, input);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
...
const WasmCoreRuntimeFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmcoreruntime_free(ptr, 1));
