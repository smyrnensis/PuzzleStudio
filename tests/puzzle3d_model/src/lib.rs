...
pub use ids::{InputId3, LayerId, ObjectId, RuleId3};
    ...
    fn game() -> Game3 {
        Game3::new_with_inputs(
            ...
            vec![
                ...
                InputDef3::directional(INPUT_BACKWARD, "backward", Direction3::BACKWARD),
        ...
        SelectorCatalog3::new(
            ...
            vec![ObjectFamily3::new(
                ...
                vec![
                    ...
                    ObjectVariant3::new(MARKER_FORWARD, vec!["forward"]),
                    ObjectVariant3::new(MARKER_BACKWARD, vec!["backward"]),
...
"#,
        ...
        assert!(!parsed.settings.camera.interactive_look);
        assert!(!parsed.settings.camera.interactive_zoom);
        assert_eq!(parsed.settings.camera.yaw_degrees, 15);
        assert_eq!(parsed.settings.camera.pitch_degrees, 55);
